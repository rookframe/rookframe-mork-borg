...
# Catalogue rows: id, name, kind, rules, price, source, damage, range, armor tier, reduction, uses.
# Named live dictionaries are constructed at the boundary; each call returns fresh data.
const ROWS: Array = [
	["femur", "Femur", "Weapon", "", "worthless", "Bare Bones · Weapons", "d4", 5, -1, "", -1],
	["arrow", "Arrow", "Equipment", "One arrow", "", "Bare Bones · Weapons", "", -1, -1, "", -1],
	["backpack", "Backpack", "Equipment", "Holds 7 normal-sized items", "6s", "Bare Bones · Equipment", "", -1, -1, "", -1],
	["battle-axe", "Battle axe", "Weapon", "", "35s", "Bare Bones · Weapons", "d8", 5, -1, "", -1],
	...
	["bolt", "Bolt", "Equipment", "One bolt", "", "Bare Bones · Weapons", "", -1, -1, "", -1],
	["bomb", "Bomb", "Equipment", "Sealed bottle", "", "Bare Bones · Starting equipment", "d10", -1, -1, "", -1],
	["bow", "Bow", "Weapon", "with Presence +10 arrows", "25s", "Bare Bones · Weapons", "d6", 30, -1, "", -1],
	...
	["club", "Club", "Weapon", "", "10s", "Bare Bones · Weapons", "d6", 5, -1, "", -1],
	["crossbow", "Crossbow", "Weapon", "with Presence + 10 bolts", "40s", "Bare Bones · Weapons", "d8", 30, -1, "", -1],
	...
	["flail", "Flail", "Weapon", "", "35s", "Bare Bones · Weapons", "d8", 5, -1, "", -1],
	...
	["handaxe", "Handaxe", "Weapon", "", "15s", "Bare Bones · Weapons", "d6", 5, -1, "", -1],
	...
	["knife", "Knife", "Weapon", "", "10s", "Bare Bones · Weapons", "d4", 5, -1, "", -1],
	...
	["mace", "Mace", "Weapon", "", "25s", "Bare Bones · Weapons", "d6", 5, -1, "", -1],
	...
	["shortbow", "Shortbow", "Weapon", "", "13s", "Bare Bones · Weapons", "d4", 30, -1, "", -1],
	["shortsword", "Shortsword", "Weapon", "", "20s", "Bare Bones · Weapons", "d4", 5, -1, "", -1],
	["sling", "Sling", "Weapon", "", "8s", "Bare Bones · Weapons", "d4", 30, -1, "", -1],
	["small-wagon", "Small wagon", "Equipment", "", "25s", "Bare Bones · Equipment", "", -1, -1, "", -1],
	["staff", "Staff", "Weapon", "", "5s", "Bare Bones · Weapons", "d4", 10, -1, "", -1],
	["sword", "Sword", "Weapon", "", "30s", "Bare Bones · Weapons", "d6", 5, -1, "", -1],
	["ten-bolts", "10 bolts", "Equipment", "10 bolts", "10s", "Bare Bones · Weapons", "", -1, -1, "", -1],
	...
	["twenty-arrows", "20 arrows", "Equipment", "20 arrows", "10s", "Bare Bones · Weapons", "", -1, -1, "", -1],
	["warhammer", "Warhammer", "Weapon", "", "30s", "Bare Bones · Weapons", "d6", 5, -1, "", -1],
	["waterskin", "Waterskin", "Equipment", "4 days of water\nCharacters begin with a waterskin", "4s", "Bare Bones · Equipment", "", -1, -1, "", -1],
	["whip", "Whip", "Weapon", "", "5s", "Bare Bones · Weapons", "d2", 10, -1, "", -1],
	["zweihander", "Zweihänder", "Weapon", "", "60s", "Bare Bones · Weapons", "d10", 5, -1, "", -1],
]
